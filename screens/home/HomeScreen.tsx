...
const HomeScreen = () => {
  ...
  const { data: kyc } = useGetKycStatusQuery(null);
  console.log("KYS", kyc);
  const { data: wallet } = useGetWalletBalanceQuery(null);
...
const styles = StyleSheet.create({
  ...
  sendCard: {
    backgroundColor: palette.primaryLight + "99",
  ...
  transCardItemAvatar: { height: 40, width: 40, backgroundColor: palette.primaryLight, borderRadius: 64 },
});
